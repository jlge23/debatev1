                        ...
                        <li class="list-group-item">
                            ...
                            <label>Validez de la respuesta:&nbsp;
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="validez1" name="validez" value="1" {{((isset($respuesta[0]->validez)) and $respuesta[0]->validez == 1) ? 'checked' : (old("validez")  == 1 ? 'checked' : '')}}>Verdadero
                                    <label class="form-check-label" for="validez1"></label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" id="validez2" name="validez" value="0" {{((isset($respuesta[0]->validez)) and $respuesta[0]->validez == 0) ? 'checked' : (old("validez")  == 0 ? 'checked' : '')}}>Falso
